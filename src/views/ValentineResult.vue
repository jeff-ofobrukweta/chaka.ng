                    ...
                    <div class="val-banner__row">
                        <div class="val-banner__text">
                            ...
                            <template v-if="searchStocks.length > 0">
                                <select name="stock-select" v-model="itemData.symbol" @change="errors = {}" class="val-form__stock" :class="{ 'is-invalid': errors.amount }">
        ...
        <section class="section v2-mobile">
            <div class="container">
                <div class="row v2-mobile__row">
                    <div class="v2-mobile__image" v-if="getWindowWidth === 'desktop'">
                        <img
                            data-sizes="auto"
                    ...
                    <div class="v2-mobile__text">
                        ...
                        <p class="hero__text v2-mobilie__text">
                            Keep your opportunities closer
                        </p>
                        <template v-if="getWindowWidth !== 'mobile'">
                            <div class="v2-mobile__store--logo">
                                <img src="../assets/img/val/logo-white.svg" alt="Chaka" />
                            </div>
                            <div class="d-none d-md-block v2-mobile__store v2-mobile__store--light">
                                <img src="../assets/img/appstore.svg" alt="App Store" />
                            </div>
                        </template>
                        <div v-else class="d-md-none v2-mobile__store v2-mobile__store--dark">
            ...
            <div class="modal-mask">
                ...
                <div class="modal-wrapper">
                    <div class="modal-container">
                        <div class="modal-body" v-if="getErrorLog.type === 'val'">
                            <div class="modal-error">
                                <img src="../assets/img/caution.svg" alt="Caution" />
                                <p>Invalid Link</p>
                            </div>
                            <div class="modal-socials modal-socials__button"><button class="btn btn-val subscribe__btn" @click="closeModal">Take yours now!</button></div>
                        </div>
                        <div class="modal-body" v-else>
                            <div class="modal-flex">
                                ...
                                <div class="modal-image">
                                    <img :src="getValResult.imageUrl" :alt="getValResult.netEarningPercentage" id="image-result" />
                                </div>
                            </div>
                            ...
                            <div class="modal-socials" v-if="canShare">
                            ...
                            <div class="modal-socials modal-socials__button" v-else><button class="btn btn-val subscribe__btn" @click="closeModal">Take yours now!</button></div>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        decrypt() {
            ...
            this.itemData.symbol = result[2];
            this.itemData.duration = result[3];
            this.getResult();
        }
    },
    mounted() {
