<template>
  <main class="main" role="main">
          ...
          <div class="v2-landing__text">
            <div class="v2-width__md">
              <div data-aos="fade" class="v2-landing__hero">
                ...
                <p
                  class="section__text"
                >Your Investment Passport. Own US, Nigerian, Chinese and global companies like Apple, Google, Dangote, Alibaba and more from any device.</p>
              </div>
              <br />
              <form
    ...
    <section class="section v2-layer container">
    ...
    <section class="v2-countries container">
