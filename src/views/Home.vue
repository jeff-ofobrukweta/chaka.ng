<template>
    <main class="main" role="main">
        <section class="v2-landing">
            <div class="container v2-landing__vector">
            ...
            <div class="container">
                <div class="row">
                    <div class="v2-landing__text">
                        <div>
                            <div class="v2-width__md" data-aos="fade">
                                <h5 class="section__caption">
                                    We Give You Access to 40+ Countries
                                </h5>
                                <h1 class="hero__title">Your Investment Passport.</h1>
                                <p class="hero__text">
                                    Own Local and Global Companies - Apple, GTBank, Google, Dangote
                                    Cement, Alibaba, Manchester United and thousands more of your
                                    favourite companies right from your phone.
                                </p>
                            </div>
                            <form
                            ...
                            <div class="v2-landing__stocks">
                                ...
                                <div class="v2-landing__news">
                                    ...
                                    >
                                        <img
                                            class="v2-landing__news--img"
                                            src="../assets/img/news/market-watch.png"
                                            alt="Maket-Watch"
                                        />
                                    </a>
                                    <a
                    ...
                    <div class="v2-landing__image-box">
                        <img
                            data-sizes="auto"
                            :data-src="require('../assets/img/landing-phone.png')"
                            :data-srcset="require('../assets/img/landing-phone.png')"
                            data-aos="fade-right"
        ...
        <section class="section v2-layer">
            <div class="container">
                <div class="row v2-layer__featured">
                    <div class="v2-layer__column">
                        <div class="v2-layer__stocks v2-layer__stocks--hide">
                            <h5 class="section__caption">Featured In</h5>
                            <div class="v2-layer__news">
                                <a
                                    href="https://www.youtube.com/watch?v=ctLC7hWFtBM"
                                    target="_blank"
                                    class="v2-layer__news--link"
                                    data-aos="fade-up"
                                >
                                    <img
                                        class="v2-layer__news--img"
                                        src="../assets/img/news/channels.png"
                                        alt="Channels"
                                    />
                                </a>
                        ...
                        <div class="v2-layer__stocks">
                            <h5 class="section__caption">Invest in funds from</h5>
                            <div class="v2-width__md v2-layer__logos">
        ...
        <section class="section v2-realize">
            <div class="container">
                <div class="row">
                    <div class="v2-realize__text">
                        <div class="v2-width__md">
                            <h1 class="hero__title" data-aos="fade-up">
                                Realize your financial goals
                            </h1>
                            <p class="section__text" data-aos="fade-up" data-aos-delay="100">
                                Make your money work for you and be free. Go global, build your
                                dream portfolio and earn dividends on your investments.
                            </p>
                            <div class="v2-layer__signup" data-aos="fade-up" data-aos-delay="50">
                                <router-link
                                    :to="{ name: 'register' }"
                                    class="v2-btn v2-btn__primary"
                                >
                                    Sign Up Now
                                    <svg
                                        width="12"
        ...
        <section class="section v2-realize">
            <div class="container">
                <div class="row">
                    <div class="v2-realize__box">
                        <div class="v2-realize__card" data-aos="fade-up">
                            <h6 class="v2-realize__card--bold">EMAIL CHECK-IN</h6>
                            <p class="v2-realize__card--normal">
                                No red tape. We remove all the jargon so you can get on board with
                                just your email.
                            </p>
                            <div class="v2-realize__card--box">
                                <img src="../assets/img/email-checkin.svg" alt="Email Checkin" />
                            </div>
                        </div>
                        <div class="v2-realize__card" data-aos="fade-up" data-aos-delay="200">
                            <h6 class="v2-realize__card--bold">NAIRA &amp; DOLLAR FUNDING</h6>
                            <p class="v2-realize__card--normal">
                                Invest with both Naira and Dollar. Frictionless and painless
                                withdrawals.
                            </p>
                            <div class="v2-realize__card--box">
                                <img
                                    src="../assets/img/naira-dollar.png"
                                    alt="Naira Dollar Funding"
                                />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 v2-realize__box">
                        <div class="v2-realize__card" data-aos="fade-up" data-aos-delay="200">
                            <h6 class="v2-realize__card--bold">FAST-TRACK VERIFICATION</h6>
                            <p class="v2-realize__card--normal">
                                We speed up the KYC process while providing you robust security and
                                regulatory protection locally and globally.
                            </p>
                            <div class="v2-realize__card--box">
                                <img src="../assets/img/fast-track.svg" alt="Fast Track" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 v2-realize__box">
                        <div class="v2-realize__card" data-aos="fade-up" data-aos-delay="300">
                            <h6 class="v2-realize__card--bold">GO BORDERLESS</h6>
                            <p class="v2-realize__card--normal">
                                Start trading and investing. Take advantage of both local and global
                                opportunities with your premium access.
                            </p>
                            <div class="v2-realize__card--box">
                                <img src="../assets/img/go-borderless.svg" alt="Go Borderless" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row v2-invest__row">
                    <div class="v2-invest__image" data-aos="fade-left" data-aos-duration="700">
                        ...
                        />
                        <img
                            :src="require('../assets/img/grow.png')"
                            alt="Invest"
                    ...
                    <div class="v2-invest__text">
                        <h2 class="hero__title">{{ invest[investNumber].title }}</h2>
        ...
        <section class="v2-countries">
            <div class="container">
                <div class="row v2-countries__row">
                    <div class="v2-countries__logos-box">
                        <div class="row">
                            ...
                            <div class="v2-countries__logos">
                                <div data-aos="fade-up">
                                    <img
                                        src="../assets/img/countries/uk.svg"
                                        alt="United Kingdom"
                                    />
                                </div>
                                <div data-aos="fade-up" data-aos-delay="340">
                            ...
                            <div class="v2-countries__logos">
                                ...
                                <div data-aos="fade-up" data-aos-delay="380">
                                    <img
                                        src="../assets/img/countries/indonesia.svg"
                                        alt="Indonesia"
                                    />
                                </div>
                            ...
                            <div class="v2-countries__logos">
                                ...
                                <div data-aos="fade-up" data-aos-delay="320">
                                    <img
                                        src="../assets/img/countries/australia.svg"
                                        alt="Australia"
                                    />
                                </div>
                                <div data-aos="fade-up" data-aos-delay="340">
                    ...
                    <div class="v2-countries__body" data-aos="fade-left">
                        ...
                        <h2 class="section__title">Trade and Invest in 40+ Countries</h2>
                        <p class="section__text">
                            First-class access to stocks listed on the NG &amp; US stock exchanges
                            as well as global blue-chip companies from around the world. Your
                            limitless investment passport is finally here.
                        </p>
                ...
                <div class="container">
                    <div class="cta__grid">
                        <div class="cta__card" data-aos="fade-left">
                            ...
                            <p class="cta__text">
                                All local equities are offered through a locally licensed brokerage
                                firm registered with the Nigerian Stock Exchange (NSE), Central
                                Securities Clearing System (CSCS) and regulated by Nigeria’s
                                Securities and Exchanges Commission (SEC). See disclosures at bottom
                                of page for more
                            </p>
                        </div>
                        <div class="cta__card" data-aos="fade-left" data-aos-delay="500">
                            ...
                            <p class="cta__text">
                                ...
                                regulated by the US Financial Industry Regulatory Authority (FINRA)
                                and the US Securities and Exchange Commission (SEC). Furthermore
                                Dollar funds deposited and assets owned are insured by the US
                                Securities Investor Protection Corporation (SIPC) up to $500,000.
                                See disclosures at bottom of page for more.
                            </p>
                        </div>
                        <div class="cta__card" data-aos="fade-left" data-aos-delay="600">
                            ...
                            <p class="cta__text">
                                All website traffic is encrypted and protected by using AES bank
                                level encryption. This provides security between your device and our
                                servers ensuring your personal and transaction details are always
                                kept private.
                            </p>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row v2-integration__row">
                    <div class="v2-countries__body">
                        <h2 class="section__title">Easy Integration</h2>
                        <p class="section__text">
                            Chaka's platform and API are available for both corporate and
                            institutional clients. From corporates running progressive Employee
                            Investment Programs to investment advisors, stockbrokers, and fund
                            managers building bespoke tools, Chaka is interoperable and can be
        ...
        <section class="v2-testimonies">
            <div class="container">
                <div class="row v2-testimonies__row">
                    <div class="col-md-6 v2-testimonies__half">
                        <div class="v2-testimonies__text">
                            <h5 class="section__caption">Verified Customer Stories</h5>
                            <h2 class="section__title">What our customers say</h2>
                            <p class="section__text">
                                Reviews, comments and love from Chaka’s customers and community.
                            </p>
                            <div class="v2-layer__signup" data-aos="fade-up" data-aos-delay="50">
                                <router-link
                                    :to="{ name: 'register' }"
                    ...
                    <div
                        class="col-md-6 v2-testimonies__half"
                        data-aos="fade-down"
                        data-aos-delay="500"
                    >
                        <div class="v2-testimonies__flickity">
                            <Flickity ref="carousel" :options="carouselOptions">
                                <div class="v2-testimonies-cell">
                                    <div class="v2-testimonies__card">
                                        <div>
                                            <p>
                                                <strong>Agozie E</strong>: I'm grateful for the
                                                platform you have designed. I'm your fan
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="v2-testimonies-cell">
                                    <div class="v2-testimonies__card">
                                        <div>
                                            <p>
                                                <strong>Girraj S</strong>: As an Indian based in
                                                Nigeria, this is a useful service as it is difficult
                                                for me to access local investments easily through
                                                trusted online parties in Nigeria. The global access
                                                is a plus.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="v2-testimonies-cell">
                                    <div class="v2-testimonies__card">
                                        <div>
                                            <p>
                                                <strong>Parker B</strong>: I am an investment
                                                enthusiast and loves the idea that I can buy stocks
                                                abroad right here in Nigeria thanks to Chaka. My
                                                experience so far has been an exciting one. As for
                                                my plans for the future, I am looking forward to
                                                transactions in their millions
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="v2-testimonies-cell">
                                    <div class="v2-testimonies__card">
                                        <div>
                                            <p>
                                                <strong>Adeyemo O.</strong>: I was an investor on
                                                the Nigerian Stock Exchange before the meltdown of
                                                the Nigerian Stock market, but I still love
                                                investment in stocks of reputable quoted companies,
                                                both Local &amp; International. That is why I have
                                                decided to sign up with Chaka
                                            </p>
                                        </div>
                                    </div>
                                </div>
