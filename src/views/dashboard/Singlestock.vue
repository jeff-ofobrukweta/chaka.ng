<template>
    <Fragment>
        <section v-if="getSingleinstrument[0] == undefined || !getSingleinstrument || getSingleinstrument[0] == null">
            unable to load the current page try reloading the browser
        </section>
        <section
        v-else 
            ...
            <section class="sumary">
                <div :title="getSingleinstrument[0].description" class="summary-cover">
                    ...
                    <svg
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M13.5411 3.93124C15.7109 1.76146 19.234 1.76154 21.4037 3.93124L29.2662 11.7938C31.4359 13.9635 31.436 17.4866 29.2662 19.6564L19.6564 29.2662C17.4866 31.436 13.9635 31.4359 11.7938 29.2662L3.93127 21.4036C1.76157 19.2339 1.76149 15.7108 3.93127 13.541L13.5411 3.93124Z" fill="#293D4A"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M32.4488 3.12882C32.5245 2.47722 32.2979 1.8271 31.8341 1.36322C31.3702 0.899333 30.72 0.672797 30.0684 0.748473C26.7883 1.12833 21.178 1.77796 17.0792 2.25265C16.1397 2.36125 15.3451 2.99811 15.034 3.89147C14.723 4.78484 14.9505 5.77747 15.6193 6.44627C18.8463 9.6733 23.5515 14.3785 26.7726 17.5996C27.4375 18.2645 28.4242 18.4905 29.3122 18.1809C30.2001 17.8718 30.8336 17.0817 30.9417 16.1475C31.4164 12.0468 32.0684 6.41727 32.4488 3.12882ZM29.0925 2.30376C28.0989 2.30376 27.292 3.11064 27.292 4.10474C27.292 5.09885 28.0989 5.90573 29.0925 5.90573C30.0866 5.90573 30.8935 5.09885 30.8935 4.10474C30.8935 3.11064 30.0866 2.30376 29.0925 2.30376Z" fill="#293D4A"/>
                    </svg>
                <div
