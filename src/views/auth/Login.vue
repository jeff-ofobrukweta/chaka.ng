                     ...
                     <section type="button" @click="authenticate('facebook')" class="socials_btn">
                         ...
                         <span style="white-space:nowrap;">Sign in with</span>
                            <svg viewBox="5 -5 30 30" enable-background="new 5 -5 30 30" class="facebook_img" title="facebook">
                                <path fill="#3C5B9A" d="M33.3-5H6.7C5.7-5 5-4.3 5-3.3v26.7c0 .9.7 1.6 1.7 1.6H21V13.4h-3.9V8.9H21V5.6c0-3.9 2.4-6 5.8-6 1.7 0 3.1.1 3.5.2v4h-2.4c-1.9 0-2.2.9-2.2 2.2v2.9h4.5l-.6 4.5h-3.9V25h7.6c.9 0 1.7-.7 1.7-1.7V-3.3c0-1-.7-1.7-1.7-1.7z">
                                </path>
                                </svg>
                         </div>
                    </section>
