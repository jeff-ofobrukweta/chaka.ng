    ...
    <main class="main" role="main">
        <div class="auth-box">
            <form class="auth-form" @submit.prevent="forgot" novalidate>
                ...
                <error-block type="forgot-password" :message="status.message" :status="status.status" />
                <div class="auth-form__group">
                    <div>
                        <action-button type="submit" :disabled="!formValid" :pending="loading" :classes="['btn-full', 'btn__primary']">Submit</action-button>
                    </div>
