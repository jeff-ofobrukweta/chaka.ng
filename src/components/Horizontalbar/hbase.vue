<template>
    <div v-if="HvaseCardloader" class="container-packet">
        <h1 class="title-name">Analyst Rating<ToolTip tooltip="View your positions. Each stock you own is shown here as a percentage of your total stock holdings."/></h1>
