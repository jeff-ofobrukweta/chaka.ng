            ...
            <div class="stock-vdr__modal">
                ...
                <div class="stock-vdr__flex">
                    ...
                    <div class="form-group stock-vdr__box stock-vdr__center">
                        ...
                        <h4 class="gift__success stock-vdr__center">{{ value.orderType }}</h4>
                    </div>
                </div>
                <div class="stock-vdr__flex">
                    <div class="form-group stock-vdr__box stock-vdr__center">
                        <label>Order Reference</label>
                        <h4 class="gift__success stock-vdr__center">{{ value.reference }}</h4>
                    </div>
                    <div class="form-group stock-vdr__box stock-vdr__center">
                        <label>Date Opened</label>
                        <h5 class="gift__success stock-vdr__center">
