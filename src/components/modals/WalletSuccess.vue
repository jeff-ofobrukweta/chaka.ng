    ...
    <modal no-header @close="closeModal">
        ...
        <div class="form-half form-half__margin" v-else>
            ...
            <div class="stock-vdr__modal">
                <p class="text-center grey-cool">You have successfully <span v-html="txText" /></p>
            </div>
            <div class="text-center">
                <br />
                <button type="button" class="btn btn__primary--outline" @click="closeModal()">
...
export default {
    ...
    computed: {
        ...
        txText() {
            ...
            return `withdrawn <strong>${this.$options.filters.currency(
                this.getWalletTx.txAmount / 100,
                this.getWalletTx.currency,
                true
            )}</strong> into your ${this.getKYC.bankAcctName}, Account Number ${
