<template>
    <component @click="showTip" tabindex="0" :is="tag" class="tooltip-span" @blur="show = false" ref="element">
        <span v-html="title"></span>
        <transition name="tooltip">
            <div v-show="show" class="tooltip" role="alert">
                <p v-html="tooltip"></p>
            </div>
        </transition>
    </component>
